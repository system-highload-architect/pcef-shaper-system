...
### Подробнее по архитектуре: [🚀 architecture](./docs/navigation.md)
### Подробнее по техническому заданию: [🚀 technical specification](./docs//srs/srs-navigation.md)
...
## 📋 General Specification Of Technical Requirements (SRS) / Общее техническое задание проекта
